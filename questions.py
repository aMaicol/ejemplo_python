...
words = random.sample(dictionary[choice], k=len(dictionary[choice]))
...
while True:
    ...
    print()
    if input("¿Te jugás otra? si/no ") == "si":
        if len(words) != 0:
            continue
        else:
            print("Ya no quedan palabras en la categoria que seleccionaste :(")
            break
    else:
        break
